...
#Ghost
execute as @e[tag=ghostboss] at @s if predicate kp:random if predicate kp:random if predicate kp:random if predicate kp:random if predicate kp:random run effect give @s speed 3 3
execute as @e[tag=ghostboss] at @s if predicate kp:random if predicate kp:random if predicate kp:random if predicate kp:random if predicate kp:random run summon vex ~ ~ ~
execute as @e[tag=ghostboss] at @s if predicate kp:random if predicate kp:random if predicate kp:random if predicate kp:random if predicate kp:random run function kp:projectiles/test