...
summon armor_stand ~ ~ ~ {Invisible:1b,NoBasePlate:0b,Pose:{Head:[180f,0f,0f]},Small:1b,Tags:["kp_projectile_ink","kp_projectile","kp_projectilecaster"]}
...
execute at @s as @e[tag=kp_projectile,distance=0] run tp @s ^ ^ ^1
