...
summon armor_stand ~ ~ ~ {Invisible:1b,NoBasePlate:0b,Pose:{Head:[180f,0f,0f]},Small:1b,Tags:["kp_projectile_trident","kp_projectile","kp_projectilecaster"],Passengers:[{id:"minecraft:item_display",item:{id:"minecraft:trident",Count:1b}}]}
